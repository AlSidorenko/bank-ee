    ...
    <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
                <li><a href="${pageContext.request.contextPath}/app/user">User Base</a></li>
                <li><a href="${pageContext.request.contextPath}/app/user/deposits"><fmt:message
                        key="header.deposits"/></a></li>
                <li><a href="${pageContext.request.contextPath}/app/user/credits"><fmt:message
                        key="header.credits"/></a></li>
            </ul>
            <ul class="nav navbar-nav navbar-right">
                <li><a href="?locale=en"><fmt:message key="header.english"/></a></li>
                <li><a href="?locale=ua"><fmt:message key="header.ukraine"/></a></li>
                <li><a href="${pageContext.request.contextPath}/app/logout"><fmt:message key="header.user.logout"/></a>
                </li>
            </ul>
        </div><!--/.nav-collapse -->
    </div>
